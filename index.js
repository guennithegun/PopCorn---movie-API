...
mongoose.connect('mongodb+srv://popcornDBAdmin:guenni@popcorndb-q3gty.mongodb.net/popcornDB?authSource=admin&retryWrites=true', {useNewUrlParser: true}, function(error){console.log(error)});
